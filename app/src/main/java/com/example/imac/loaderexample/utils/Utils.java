...
public final class Utils {
    ...
    public static List<DBItem> fetchApiData(String requestUrl) {
        URL url = createUrl(requestUrl);
        Log.e("fetchApiData: API:-", requestUrl);
        ...
        List<DBItem> earthquake = extractFeatureFromJson(jsonResponse);
    ...
    private static List<DBItem> extractFeatureFromJson(String JSONStr) {
        ...
        try {
            JSONArray baseJsonResponse = new JSONArray(JSONStr);
